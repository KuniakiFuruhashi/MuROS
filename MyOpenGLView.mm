...
-(void)drawTrajectory:(string) fn
{
	...
	double t,p0x,p0y,p0z,p0l,v0x,v0y,v0z,p1x,p1y,p1z,p1l,v1x,v1y,v1z,u;
	double wx,wy,wz;
	...
	fscanf(fp,"%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%d%lf%lf%lf",&t,&p0x,&p0y,&p0z,&p0l,&v0x,&v0y,&v0z,&wx,&wy,&wz,&u,
		   ...
		   &r_shape[7][0],&r_shape[7][1],&r_shape[7][2],&collisionPid,&sunx,&suny,&sunz);
	
	
	//while (fscanf(fp,"%lf%lf%lf%lf%lf%lf%lf%lf%lf",&t,&p1x,&p1y,&p1z,&p1l,&v1x,&v1y,&v1z,&u) != EOF) 
	while (fscanf(fp,"%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%lf%d%lf%lf%lf",&t,&p1x,&p1y,&p1z,&p1l,&v1x,&v1y,&v1z,&wx,&wy,&wz,&u,
				  &r_shape[0][0],&r_shape[0][1],&r_shape[0][2],
				  &r_shape[1][0],&r_shape[1][1],&r_shape[1][2],
				  &r_shape[2][0],&r_shape[2][1],&r_shape[2][2],
				  &r_shape[3][0],&r_shape[3][1],&r_shape[3][2],
